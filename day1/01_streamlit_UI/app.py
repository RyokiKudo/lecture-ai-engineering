...
## 小数値の増減
number = st.number_input('少数を増減', 0.0)

## 数式
st.latex(r'''
 lim_{N \to \infty} \prod_{n=1}^N \left( 1 + \frac{1}{n^2} \sum_{k=1}^\infty \frac{(-1)^k}{k!} \left( \frac{\partial^k}{\partial x^k} e^{-x^2} \Big|_{x=n} \right) \right)
''')
